...
- **使用中文进行交流对话**
- **优先查看项目的结构**
- **查看当前项目的 readme.md「先查看当前项目的 readme，在查看当前组件的 readme」「或者用户明确提出查看某个文档」文档，了解项目需求、背景、条件。**
- **每次对话前先整理对话历史总结用户提及的相关信息，整理并理解用户需求，并提出提出你认为可以更好的方案**
- **开发组件过程中，需要自行 mock 数据「在接口函数中从外部引用数据返回，方便后续直接改动接口路径即可」**
- **开发过程中需要保证数据不会出错，语法没有问题，页面正常运行不会报错，完成后需要编写测试用例并输出，以及输出本次修改内容*test*文档，让用户审核你是否准确理解并完成需求，在下次对话之前，先删除测试用例数据和输出文档。**
- **当用户在对话框提出了在全局事件中的注意事项或者要求，那么请你更新 readme.md「先查看当前项目的 readme，在查看当前组件的 readme，选择合适的文档更新」文档并整理。**
